...
class Crypto extends CI_Controller {
	...
	public function addgallery()
	{
		...
		if(isset($_POST['submit'])){
			...
			$this->load->model('Mcrypto');
				$this->Mcrypto->addgallery();

		}
		$this->load->view('crypto/addgallery');
	...
	public function viewgallery()
	{
		...
		$this->load->view('include/topbar');
		$this->load->view('include/nav', $nav);
		$this->load->view('crypto/viewgallery');
		$this->load->view('include/footer');
	}
	...
	{$nav=array('title'=>'single Page','bc'=>array(
		...
		$this->load->view('include/topbar');
		$this->load->model('Mcrypto');
			$data['k']=$this->Mcrypto->singleView();
		$this->load->view('include/nav', $nav);
		$this->load->view('crypto/singlegallery', $data);
		$this->load->view('include/footer');
	}
...
public function updategallery()
{
	...
	if(isset($_POST['submit']))
			...
			$this->load->view('crypto/updategallery',$data);
			$this->load->view('include/footer');
}
