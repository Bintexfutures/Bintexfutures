...
class Sponser extends CI_Controller {
	...
	{$nav=array('title'=>'single Page','bc'=>array(
		...
		$this->load->view('include/header');
		$this->load->view('include/topbar');
		$this->load->model('Model_sponser');
			$data['k']=$this->Model_sponser->singleView();
		$this->load->view('include/nav', $nav);
		$this->load->view('sponser/singleview', $data);
		$this->load->view('include/footer');
	}
...
public function update()
{
	...
	if(isset($_POST['submit']))
			{
				$this->load->model('Model_sponser');
				$this->Model_sponser->updateabout();
			}
	        $this->load->view('include/header');
			$this->load->view('include/topbar');
			$this->load->view('include/nav');
			...
			$this->load->view('sponser/updatepage',$data);
			$this->load->view('include/footer');
}
