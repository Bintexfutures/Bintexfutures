...
class Abstractsubmission extends CI_Controller {
	...
	{	
		...
		$this->load->view('include/topbar');
		$this->load->view('include/nav');
		$this->load->view('scientificsession/view');
		$this->load->view('include/footer');
	}
	...
	public function singlepage()
	{
		...
		$this->load->view('include/topbar');
		$this->load->model('Model_committee');
			$data['k']=$this->Model_committee->singleView2();
		$this->load->view('include/nav');
		$this->load->view('scientificsession/single2', $data);
		$this->load->view('include/footer');
	}
...
{
		$id=$this->uri->segment(3);
		$del=$this->db->delete('abstractsubmission',array('id'=>$id));
		//echo $this->db->last_query();
		redirect('abstractsubmission/view','refresh');
