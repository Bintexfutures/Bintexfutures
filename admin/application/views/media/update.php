...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-yellow">
            <div class="panel-heading">Update Media Partners
            ...
            <div class="form-body pal new-form">
                ...
                <div class="form-group col-md-4 mbn">
                    ...
                    <div class="input-icon right">
                        <input type="text" name="heading" value="<?php echo @$k->heading?>" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group col-md-4 mbn">
                    ...
                    <div class="input-icon right">
                        <input type="text" name="url" value="<?php echo @$k->url?>" class="form-control">
                    </div>
                </div>
             ...
             if(!file_exists ($bb)) { ?>
                 <img src="<?php echo base_url();?>assets/noimage/noimage.jpg" height="75" width="150">
                  <?php } else {?>

  <img   height="50" width="120" src="<?php echo base_url();?>assets/aboutpage/<?php echo $k->image;?>">
                  <?php }?>
</div>
                ...
                <div class="form-group col-md-12 mbn">
                    ...
                    <textarea id="inputContent" rows="10" col="15" class="form-control vbn" name="description" ><?php echo @$k->description?></textarea>
                </div>
