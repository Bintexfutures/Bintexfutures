<?php
    $data1=$this->db->order_by('id', 'desc')->get_where('contactinquiry')->result();
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <a class="btn btn-danger btn-xs" href="<?php echo base_url();?>contactenquiry/delete/<?php echo $h->id?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
