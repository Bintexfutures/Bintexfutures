...
<div class="form-group col-md-4 mbn">
                    ...
                    <div class="input-icon right">
                        <input type="text" name="username" <?php echo @$k->username?> class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group col-md-4 mbn">
                    ...
                    <div class="input-icon right">
                        <input type="text" name="email" <?php echo @$k->email?> class="form-control">
                    </div>
                </div>
                 ...
                 <div class="form-group col-md-4 mbn">
                    ...
                    <div class="input-icon right">
                        <input type="text" name="password" <?php echo @$k->password?> class="form-control">
                    </div>
                </div>
