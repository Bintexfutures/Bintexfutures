...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-yellow">
            <div class="panel-heading"> Add Latest Updates
...
<div class="row">
   <div class="col-lg-12">
      <div class="panel panel-yellow">
         <div class="panel-heading">View Latest Updates
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <a href="<?php echo base_url();?>latestupdates/update/<?php echo $h->id?>"><button type="button" class="btn btn-success btn-xs btnsup">
                            Edit</button></a>
                        <a href="<?php echo base_url();?>latestupdates/delete/<?php echo $h->id?>" 
