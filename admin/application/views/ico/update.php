...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-yellow">
            <div class="panel-heading">Update ICO Stages
...
<?php if ($this->session->flashdata('del')):?>
  ...
  <div class="form-group col-md-8 mbn">
                ...
                <div class="form-group col-md-12 mbn">
                    ...
                    <div class="input-icon right">
                         <textarea id="inputContent" rows="10" col="15" class="form-control gfhfghj vbn" name="session" ><?php echo @$k->session?> </textarea>
