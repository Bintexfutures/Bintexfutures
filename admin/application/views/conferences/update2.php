...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-yellow">
            <div class="panel-heading">Update Conference
...
<?php if ($this->session->flashdata('del')):?>
            ...
            <div class="form-group col-md-6 mbn">
                    ...
                    <div class="input-icon right">
                        <input type="text" name="date" class="form-control" value="<?php echo @$k->date?>">
                    </div>
                </div>
                ...
                <div class="form-group col-md-6 mbn">
                    ...
                    <div class="input-icon right">
                        <input type="text" name="location" class="form-control" value="<?php echo @$k->location?>">
                    </div>
                </div>
                ...
                <div class="form-group col-md-6 mbn">
                    ...
                    <div class="input-icon right">
                        <input type="text" name="subname" class="form-control" value="<?php echo @$k->subname?>">
                    </div>
                </div>
  ...
  <img   height="50" width="50" src="<?php echo base_url();?>assets/aboutpage/<?php echo $k->image;?>">
         ...
         <div class="form-group col-md-6 mbn">
                    <label for="inputAddress" class="control-label">Conferences URL
                        <span class='require'>*</span></label>

                    <div class="input-icon right">
                        <input type="text" name="url" class="form-control" value="<?php echo @$k->url?>">
                    </div>
                </div>
