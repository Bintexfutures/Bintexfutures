...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-yellow">
            <div class="panel-heading"> Add Success
            ...
            <div class="form-body pal">
                ...
                <div class="form-group mbn">
                    ...
                    <div class="input-icon right">
                        <input type="text" placeholder="" class="form-control" name="name" required="required"/>
                    </div>
                </div>
...
<div class="form-group mbn">
                    <label for="inputAddress" class="control-label"> Professional Work
                        <span class='require'>*</span></label>

                    <div class="input-icon right">
                        <input type="text" placeholder="" class="form-control" name="professional" required="required"/>
 ...
 <div class="form-group mbn">
               ...
               <div class="form-group mbn">
                    ...
                    <textarea id="inputContent" rows="10" col="15" class="form-control vbn" name="descriptions" ></textarea>
                </div>
