...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-yellow">
            <div class="panel-heading">  Add Scientific Session
...
<?php
    $data1=$this->db->order_by('id', 'desc')->get_where('scientificprograms')->result();
...
<?php if($u->status=='1'){ ?>
                 ...
                 <a class="btn btn-danger btn-xs" href="<?php echo base_url();?>scientificsession/active/<?php echo $h->id?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
