                    ...
                    <div class="input-icon right">
                        ...
                        <select name="cat" class="form-control"  required="required">                          
                             <option value="">Select</option>
                              ...
                              <option value="Pre-ICO & ICC">Pre-ICO & ICC </option>   
                              <option value="ICO Tokens">ICO Tokens</option>   
...
<script type="text/javascript">
  function jou(value)
  {
    ...
    <?php
    $data1=$this->db->order_by('id', 'desc')->get_where('scientific1')->result();
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <a href="<?php echo base_url();?>faq/update/<?php echo $h->id?>"><button type="button" class="btn btn-success btn-xs btnsup">
                            Edit</button></a>
                        <a href="<?php echo base_url();?>faq/delete/<?php echo $h->id?>" 
