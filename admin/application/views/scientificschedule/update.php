...
<input type="text" name="cat" class="form-control" value="<?php echo @$k->cat?>" readonly>
                    </div>
                </div>
                ...
                <div class="form-group col-md-6 mbn">
                    ...
                    <div class="input-icon right">
                        <input type="text" name="time" class="form-control" value="<?php echo @$k->time?>">
                    </div>
                </div>
                ...
                <div class="form-group col-md-12 mbn">
                    ...
                    <div class="input-icon right">
                        <textarea rows="4" class="form-control" name="session"><?php echo @$k->session?></textarea>
