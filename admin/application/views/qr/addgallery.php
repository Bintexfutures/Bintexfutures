...
<?php
    $data1=$this->db->order_by('id', 'asc')->get_where('qr')->result();
   
    ?>
<div class="row">
   <div class="col-lg-12">
      <div class="panel panel-yellow">
         <div class="panel-heading">View  QR Code</div>
            ...
            <table class="table table-hover">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td><img width="40" src="<?php echo base_url() ?>assets/qr/<?php echo $h->img ?>"></td>
...
<?php if($u->status=='1'){ ?>
<a class="btn btn-danger btn-xs" href="<?php echo base_url();?>qr/updategallery/<?php echo $h->id?>" >Edit</a>
