...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-yellow">
            <div class="panel-heading">Update <?php echo @$k->pagename?>
...
<form  method="post" enctype="multipart/form-data">
    ...
    <div class="form-group mbn">
        <label for="inputAddress" class="control-label">Page Heading<span class='require'>*</span></label>
    ...
    <div class="form-group mbn">
        <label for="inputContent" class="control-label">Page Content</label>
        <textarea id="inputContent" rows="10" col="15" class="form-control gfhfghj vbn" name="content" ><?php echo @$k->content?> </textarea>
    </div>
    ...
    <div class="form-group mbn">
        <label for="inputContent" class="control-label">Page Content</label>
        <textarea id="inputContent" rows="10" col="15" class="form-control gfhfghj vbn" name="content2" ><?php echo @$k->content2?> </textarea>
    </div>
