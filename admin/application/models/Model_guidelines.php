...
class Model_guidelines extends CI_Model {
...
public function singleView()
{
	...
	$query=$this->db->get_where('guidelines',array('id'=>$id))->row();
	return $query;
}
...
public function updateabout()
{
	...
	extract($_POST);	
			...
			if(@$nm!=""){
				$gt=$this->db->get_where('guidelines',array('id'=>$id))->row();
			...
			$res=$this->db->update('guidelines',$add, array('id'=>$id) );
