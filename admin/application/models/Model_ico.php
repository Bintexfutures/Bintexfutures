...
class Model_ico extends CI_Model {
...
public function singleView()
{
	...
	$query=$this->db->get_where('ico',array('id'=>$id))->row();
	return $query;
}
...
public function update()
{
	...
	extract($_POST);
			...
			$ip=$_SERVER['REMOTE_ADDR'];
			if(@$nm!=""){
				$gt=$this->db->get_where('ico',array('id'=>$id))->row();
			...
			$res=$this->db->update('ico',$add, array('id'=>$id) );
			if($res==true)
			{
