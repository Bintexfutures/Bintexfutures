        ...
        <div>           
			...
			<div class="col-md-12 col-sm-12">
				<div class="card card-primary mb-4">
					...
					<div class="panel-heading">
						 <h4 class="panel-title">Driver's License</h4>
					</div>
                    <div class="row">
...
<div class="col-xl-12 col-lg-12 col-sm-12 d-flex justify-content-center">
            ...
            <?php $re=$this->session->userdata('userlogin'); $dt=$this->db->get_where('kyc',array('customer_id'=>$re->id))->row(); ?>
                        ...
                        <div class="col-xl-4 col-lg-4 col-sm-12 d-flex justify-content-center">
                            <div class="prev-box text-center" name="passport">
								<img src="<?php echo base_url() ?>assets/passport/<?php echo @$dt->d1 ?>" style=" width:100%; height:auto" >
								<p>Passport Front Image</p>
							</div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-sm-12 d-flex justify-content-center">
                            <div class="prev-box text-center" name="passport">
								<img src="<?php echo base_url() ?>assets/passport/<?php echo @$dt->d2 ?>" style=" width:100%; height:auto" >
 ...
 <form class="row" method="post" enctype="multipart/form-data">
     	  ...
     	  <div class="col-xl-6 col-lg-4 col-sm-12 d-flex justify-content-center">
