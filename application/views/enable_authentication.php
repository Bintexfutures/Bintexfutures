  ...
  <div class="content-wrapper">
      ...
      <div class="row">
      	<div class="offset-md-2 col-md-8">
			...
			<div class="card-header">
                <h4 class="mb-0">Enable Authentication</h4>
            </div><br><br> 
	...
	<div class="offset-md-2 col-md-8">
			<div class="col-form-label input-group">       
				<input type="text" class=" form-control" placeholder="Login Password">
		</div>
	</div>
</div>
...
<div class="row">
	<div class="offset-md-2 col-md-8">
		<div class="col-form-label input-group"> 
		    <input type="text" class=" form-control" placeholder="Google Authencater Code">
		</div>
	</div>
</div>
<div class="text-center">
								<a href="#" class="btn btn-default mt-4 mb-4 mar-rt">Enable Authentication</a>
								</div>
								<br><br><br><br>
