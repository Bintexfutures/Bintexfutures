        ...
        <div>           
			...
			<div class="col-md-12 col-sm-12">
				<div class="card card-primary mb-4">
					...
					<div class="panel-heading">
						 <h3 class="panel-title">Identity Card</h3>
					</div>
                    <div class="row">
            ...
            <?php $re=$this->session->userdata('userlogin'); $dt=$this->db->get_where('kyc',array('customer_id'=>$re->id,))->row(); ?>
                        ...
                        <div class="col-xl-4 col-lg-4 col-sm-12 d-flex justify-content-center">
                            <div class="prev-box text-center" name="passport">
								<img src="<?php echo base_url() ?>assets/passport/<?php echo @$dt->i1 ?>" style=" width:100%; height:auto" >
								<p>Identity Card Front Image</p>
							</div>
                        </div>
                        
                        <div class="col-xl-4 col-lg-4 col-sm-12 d-flex justify-content-center">
                            <div class="prev-box text-center" name="passport">
								<img src="<?php echo base_url() ?>assets/passport/<?php echo @$dt->i2 ?>" style=" width:100%; height:auto" >
								<p>Identity Card Back Image</p>
							</div>
                        </div>
